...
1. Put the file in `public/images/projects/` (or `public/images/portrait.jpg` / `portrait-2.jpg` for the two small, staggered cover portraits).
...
| Cover | `portrait.jpg` (square) · `portrait-2.jpg` (3:4) |
